...
| TASK-008                                   | 战斗纵向切片               | P1     | Proposed | 007                                       |
| TASK-009                                   | 原型15技能与选卡           | P1     | Proposed | 008                                       |
| TASK-010                                   | Boss与4分钟闭环            | P1     | Proposed | 009                                       |
| TASK-011                                   | 原型试玩复盘               | P1     | Proposed | 010                                       |

Proposed是待细化backlog；正式领取前建立任务卡。没有已发布的微信游戏版本。
当前工作停在设计和接入准备，不自动推进玩法开发。
